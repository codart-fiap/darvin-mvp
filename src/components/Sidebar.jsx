...
import { 
    ...
    ChatDotsFill, 
    Upload,
    LightbulbFill // <-- Ícone adicionado
} from 'react-bootstrap-icons';
import { useAuth } from '../hooks/useAuth';

// Componente auxiliar para os links, para evitar repetição
...
const Sidebar = () => {
  ...
  const renderRetailLinks = () => (
    <>
      ...
      <SidebarLink to="/retail/assistant" icon={<LightbulbFill />}>Assistente</SidebarLink> {/* <-- ADICIONADO */}
